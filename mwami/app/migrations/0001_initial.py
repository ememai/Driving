...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sign_image', models.FileField(unique=True, upload_to='images/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('choices', models.ManyToManyField(related_name='questions', to='app.choice')),
                ...
                ('sign', models.ManyToManyField(blank=True, related_name='questions', to='app.roadsign')),
            ],
        ),
        migrations.CreateModel(
            name='Exam',
        ...
        migrations.AddField(
            model_name='choice',
            name='image_choice',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='app.roadsign'),
        ),
        migrations.CreateModel(
            name='Subscription',
            fields=[
