# Generated by Django 5.1.6 on 2025-03-26 09:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('choices', models.JSONField(help_text="Choices in JSON format. Example: [{'text': 'Option 1', 'road_sign_id': null, 'is_correct': true}, {'text': null, 'road_sign_id': 3, 'is_correct': false}]")),
                ('order', models.PositiveIntegerField(blank=True, help_text='Order of the question in the exam', null=True)),
        ...
        migrations.AddField(
            model_name='question',
            name='sign',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='app.roadsign'),
        ),
        migrations.CreateModel(
            name='Choice',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('text', models.CharField(blank=True, max_length=255, null=True, unique=True)),
                ('date_added', models.DateTimeField(auto_now_add=True)),
                ('date_updated', models.DateTimeField(auto_now=True)),
                ('image_choice', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app.roadsign')),
            ],
        ),
        migrations.CreateModel(
            name='ScheduledExam',
